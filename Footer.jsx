  ...
  const cols = [
    {
      ...
      items: [
        ...
        { label: 'Lavandería',       href: 'https://neugreen.mx/productos.html?tab=lavanderia#lavanderia' },
        { label: 'Jarciería',        href: 'https://neugreen.mx/productos.html?tab=jarcieria#jarcieria' },
