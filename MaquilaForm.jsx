// MaquilaForm.jsx — strong form for manufactura intake
  ...
  return (
    <section id="form" style={{
      ...
      <div className="ng-maq-form-layout" style={{
        ...
        <div>
          <div className="eyebrow" style={{ color: 'var(--ng-green-700)', marginBottom: 12 }}>Iniciar manufactura</div>
          <h2 style={{
          ...
          <p style={{ fontSize: 16, color: 'var(--ng-steel)', margin: '0 0 28px', lineHeight: 1.55, maxWidth: 380 }}>
            Cuéntanos qué producto quieres manufacturar, qué volumen estimas y si tienes formulación o necesitas desarrollo. NDA mutua firmable en cualquier punto.
          </p>
        ...
        <form onSubmit={(e) => { e.preventDefault(); setSent(true); }}
              data-lead-source="manufactura-form"
              style={{
                background: '#fff', border: '1px solid var(--ng-line)',
          ...
          <div style={{ marginBottom: 14 }}>
            <label style={label}>Tipo de producto a manufacturar</label>
