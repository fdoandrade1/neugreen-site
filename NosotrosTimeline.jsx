...
function NosotrosTimeline() {
  const events = [
    ...
    { year: '2017', title: 'Manufactura para terceros', body: 'Apertura formal de la unidad de marca privada. Primer cliente: cadena de hoteles boutique de Riviera Maya.' },
