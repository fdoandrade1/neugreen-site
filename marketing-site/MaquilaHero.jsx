    ...
    <section style={{
      ...
      <div style={{ maxWidth: 'var(--container-max)', margin: '0 auto', position: 'relative' }}>
        <div style={{
          ...
          <span style={{ color: 'var(--ng-ink)', fontWeight: 600 }}>Maquila y marca privada</span>
        </div>

        <div className="eyebrow" style={{ color: 'var(--ng-green-700)', marginBottom: 14 }}>Línea 02 · Maquila</div>
        <h1 style={{
