// MaquilaBand.jsx — alternating band promoting private-label / maquila line
  ...
  return (
    <section style={{
      ...
      <div style={{
        ...
        <div>
          <div className="eyebrow" style={{ marginBottom: 12 }}>02 · Maquila y marca privada</div>
          ...
          <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
            ...
            }}>Solicitar propuesta de maquila</button>
            <button style={{
