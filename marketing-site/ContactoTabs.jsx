// ContactoTabs.jsx — 3 segmented forms (Productos / Maquila / Industrial) + contact info column
...
function MaquilaFormCT() {
  ...
  return (
    <form onSubmit={(e) => { e.preventDefault(); setS(true); }} data-lead-source="contacto-maquila">
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14, marginBottom: 14 }}>
        <div><label style={labelStyle}>Empresa</label><input style={inputStyle} value={f.empresa} onChange={e => setF({ ...f, empresa: e.target.value })} placeholder="Razón social" required /></div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14, marginBottom: 14 }}>
        <div>
          <label style={labelStyle}>Producto a maquilar</label>
...
function ContactoTabs() {
  ...
  const tabs = [
    ...
    { id: 'maquila',    label: 'Maquila',    accent: 'green', sub: 'Brief de marca privada' },
        ...
        <aside style={{ position: 'sticky', top: 96 }}>
          <div style={{
            ...
            <ul style={{ margin: 0, padding: 0, listStyle: 'none', display: 'flex', flexDirection: 'column', gap: 18 }}>
              {[
                { ico: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5Z"/></svg>, label: 'WhatsApp ventas', value: '+52 444 123 4567', sub: '< 24 h hábiles' },
                ...
                { ico: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16v16H4z"/><path d="m4 6 8 7 8-7"/></svg>, label: 'Contacto general', value: 'contacto@neugreen.mx', sub: 'Maquila + industrial' },
